...
console.log("Axios instance created with base URL:", axios.defaults.baseURL);

console.log("base url at api.js file is ",process.env.NEXT_PUBLIC_BACKEND_URL);
...
export async function deleteInvoiceData(invoiceId) {
    ...
    try {
        ...
        const result = await axios.get(`/get-invoice-details/${invoiceId}`, data);
