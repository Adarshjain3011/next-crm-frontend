...
export const removeSalesPersonFromEnquery = async(data)=>{

    try{

        const result = await axios.post("/removeSalesPersonFromEnquery",data);
...
export const removeImageFromQuotes = async(data)=>{

    try{

        console.log("data at removeImageFromQuotes ",data);

        const result = await axios.post("/remove-image-from-quote",data);
